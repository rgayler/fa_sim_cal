...
I am not going to use name suffix in entity resolution
because age should be sufficient and is much better quality.

Just look at what turns up in the name suffix
in order to see what occurs,
so that the same values can be removed from the other name fields
where they shouldn't occur but do.
...
* As entire first name: MRS, REV, DR, MISS, MISTER, PROFESSOR, SISTER, SR
