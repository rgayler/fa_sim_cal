...
-   Dictionaries are constructed from entity data records, so having
    ...
    -   The easiest way to partition the records is to literally
        partition the entity data record into train and test universes.

        -   Note that common names will occur in both data sets.

    -   Partitioning the entity records so that each name type occurred
        in only one of the train or test data sets would be easy if
...
node [shape = circle, fixedsize = true, fontsize = 6]
...
train -> {qry ds_90 ds_70 ds_50 ds_30 ds_10}
